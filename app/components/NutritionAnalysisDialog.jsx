  ...
  const renderNutrientSection = (sectionKey, items) => {
    ...
    return (
      <div className="mb-6">
        <h3
          className={cn(
            'mb-2 text-base sm:text-lg font-semibold',
      ...
      <div className="fixed inset-0 flex items-center justify-center overflow-y-auto p-4">
        ...
        >
          ...
          >
            ...
            >
              <div className="p-fluid-base">
                <div className="flex items-start justify-between gap-fluid-4">
                  <div className="flex-1">
                    <Dialog.Title
                      className={cn(
                        'mb-fluid-2 flex items-center gap-fluid-2 text-fluid-xl font-bold',
                        ...
                        <div className="flex gap-fluid-2">
                          {nutritionData.dietLabels.map((label, index) => (
                            <span
                              key={index}
                              className={cn(
                                'rounded-full px-fluid-2 py-fluid-1 text-fluid-xs',
                                theme === 'dark'
            ...
            {/* Scrollable Content */}
            <div className="flex-1 overflow-y-auto p-fluid-base">
              ...
              {!hasNoNutrients && (
                ...
                >
                  ...
                  <motion.div
                    ...
                    transition={{ duration: 0.3 }}
                    className={cn(
                      'relative mb-fluid-6 flex flex-col items-center justify-center overflow-hidden rounded-xl p-fluid-base',
                      theme === 'dark' ? 'bg-gray-800/50' : 'bg-gray-50'
                    )}
                  >
                    <div className="mb-fluid-3 flex items-center gap-fluid-3">
                      <IoFlame
                        className={cn(
                          'h-10 w-10',
                    ...
                    >
                      {nutritionData.calories || 0}
                      <span className="ml-fluid-2 text-fluid-2xl font-normal text-gray-500">
                        {t('units.kcal')}
                      </span>
                    </motion.div>
                  </motion.div>
